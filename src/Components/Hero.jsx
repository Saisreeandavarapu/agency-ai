...
const Hero = () => {
  return (
    ...
    px-4 sm:px-12 lg:px-24 xl:px-40 text-center w-full 
   ...
   xl:leading-[95px] max-w-5xl'>Truning imaginstion into <span className='bg-gradient-to-r from-[#5044E5] to-[4d8cea] bg-clip-text
   text-transparent'>digital</span>impact.</h1>
   <p className='text-sm sm:text-lg font-medium text-gray-500 dark:text-white/75
   max-w-4/5 sm:max-w-lg pb-3'>Creating meaningful connections and Truning big ideas into interactive digital experiences.</p>
