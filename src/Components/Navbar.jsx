...
const Navbar = ({theme,settheme}) => {
  ...
  return (
    <div className='flex justify-between items-center px-4 sm:px-12 lg:px-24 xl:px-40 py-4 sticky z-20 backdrop-blur-xl font-medium bg-white/50 dark:bg-gray-900/70'>
        ...
        max-sm:pl-10`} max-sm:fixed top-0 bottom-0 right-0 max-sm:min-h-screen max-sm:h-full
    ...
    <div className='flex items-center gap-2 sm:gap-4'>
       <ThemeToggleBtn theme={theme} settheme={settheme}/>
        ...
        items-center gap-2 bg-primary text-white px-6 py-2 rounded-full cursor-pointer hover:scale-103 transition-all'>Connect <img src={assets.arrow_icon} alt="" width={14} /></a>
    </div>
