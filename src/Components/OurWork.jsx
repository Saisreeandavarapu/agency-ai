...
const OurWork = () => {
    const workdata=[
        {
            ...
            description:`We turn bold ideas into powerful digital soultions that 
            connect,engage`,
  ...
  return (
    ...
    xl:px-40 pt-30 text-gray-700 dark:text-white'  >
     <Title title='Our latest work' desc='From strategy to execution, we craft digital soultions
